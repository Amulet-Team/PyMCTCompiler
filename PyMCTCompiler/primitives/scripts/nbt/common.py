...
java_str_lock = NBTRemapHelper(
    [(("Lock", "string", []), ("Lock", "string", [("utags", "compound")]))],
    '{Lock: ""}',
)

java_keep_packed = NBTRemapHelper(
    [(("keepPacked", "byte", []), ("keepPacked", "byte", [("utags", "compound")]))]
)

java_loot_table = NBTRemapHelper(
    [
        (("LootTable", "string", []), ("LootTable", "string", [("utags", "compound")])),
        (
            ("LootTableSeed", "long", []),
...
java_item_1 = NBTRemapHelper(
    [(("Item", "compound", []), ("Item", "compound", [("utags", "compound")]))], "{}"
)

java_items_3 = NBTRemapHelper(
    [(("Items", "list", []), ("Items", "list", [("utags", "compound")]))], "{Items: []}"
)
...
java_furnace_base = NBTRemapHelper(
    [
        ...
        (("CookTime", "short", []), ("CookTime", "short", [("utags", "compound")])),
        (
            ("CookTimeTotal", "short", []),
...
bedrock_furnace_base = NBTRemapHelper(
    [
        ...
        (("StoredXPInt", "int", []), ("StoredXPInt", "int", [("utags", "compound")])),
    ],
...
bedrock_is_movable = NBTRemapHelper(
    [(("isMovable", "byte", []), ("isMovable", "byte", [("utags", "compound")]))],
    "{isMovable: 1b}",
)
...
bedrock_findable = NBTRemapHelper(
    [(("Findable", "byte", []), ("Findable", "byte", [("utags", "compound")]))],
    "{Findable: 0b}",
)
